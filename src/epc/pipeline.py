...
ProviderRegistry: parse -> normalize -> optimization passes -> batch
planning -> incremental diff -> provider lowering.
...
from .passes import DEFAULT_PASSES, BatchPlanner, PassManager, ProviderLowering
